...
const sandbox = { self: null, console, fetch, FormData, Blob, URLSearchParams, crypto, TextEncoder, btoa, Date, Math, JSON, Promise, Error, String, Number, Object, Array, isFinite, parseInt, setTimeout, location: { origin: 'https://x.github.io' } };
